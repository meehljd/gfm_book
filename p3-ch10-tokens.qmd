...
- Validate that cross-references to other chapters (@sec-dna, @sec-hybrid, @sec-princ, @sec-reg, @sec-splice) still point to the right sections after final re-organization
