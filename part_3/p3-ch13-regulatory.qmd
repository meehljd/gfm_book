...
![**FIGURE PLACEHOLDER A**](../figs/part_3/ch13/01-A-fig-long-range-regulation.png)

![**FIGURE PLACEHOLDER B**](../figs/part_3/ch13/01-B-fig-long-range-regulation.png)

![**FIGURE PLACEHOLDER C**](../figs/part_3/ch13/01-C-fig-long-range-regulation.png)

![**FIGURE PLACEHOLDER D**](../figs/part_3/ch13/01-D-fig-long-range-regulation.png)
...
![**FIGURE PLACEHOLDER**](../figs/part_3/ch13/02-fig-enformer-architecture.png)
...
![**FIGURE PLACEHOLDER**](../figs/part_3/ch13/03-fig-regulatory-vep-workflow.png)
...
![**FIGURE PLACEHOLDER A**](../figs/part_3/ch13/04-A-fig-borzoi-rnaseq.png)

![**FIGURE PLACEHOLDER B**](../figs/part_3/ch13/04-B-fig-borzoi-rnaseq.png)

![**FIGURE PLACEHOLDER C**](../figs/part_3/ch13/04-C-fig-borzoi-rnaseq.png)

![**FIGURE PLACEHOLDER D**](../figs/part_3/ch13/04-D-fig-borzoi-rnaseq.png)
...
These biases propagate to variant effect predictions. A variant in a regulatory element active primarily in pancreatic beta cells may receive poor predictions if beta cell data is sparse in training. A variant on a **haplotype** common in African populations but rare in Europeans may fall outside the model's effective training distribution. Users must recognize that prediction confidence varies with representation in training data, a consideration that current models do not explicitly communicate. @sec-ch22-confounding examines how such biases can compromise model validity.
...
Linear sequence models treat DNA as a one-dimensional string, but gene regulation occurs in three-dimensional nuclear space. Chromatin loops bring distal elements into proximity; nuclear compartmentalization segregates active and repressed regions; phase-separated condensates concentrate regulatory factors. While *AlphaGenome* predicts some contact features, current hybrid models do not fully integrate three-dimensional chromatin organization. The relationship between linear sequence, three-dimensional structure, and regulatory output remains incompletely captured. @sec-ch17-3d-genome examines models that explicitly address chromatin architecture.
...
![**FIGURE PLACEHOLDER A**](../figs/part_3/ch13/05-A-fig-regulatory-limitations.png)

![**FIGURE PLACEHOLDER B**](../figs/part_3/ch13/05-B-fig-regulatory-limitations.png)

![**FIGURE PLACEHOLDER C**](../figs/part_3/ch13/05-C-fig-regulatory-limitations.png)

![**FIGURE PLACEHOLDER D**](../figs/part_3/ch13/05-D-fig-regulatory-limitations.png)
