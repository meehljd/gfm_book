...
![Regulatory elements span large genomic distances](../figs/part_3/ch16/01-A-fig-long-range-regulation.svg)

![Model context limits what can be captured](../figs/part_3/ch16/01-B-fig-long-range-regulation.svg)

![Expression prediction requires long-range integration](../figs/part_3/ch16/01-C-fig-long-range-regulation.svg)

![Distribution of enhancer-promoter distances](../figs/part_3/ch16/01-D-fig-long-range-regulation.svg)
...
![Enformer hybrid CNN-transformer architecture](../figs/part_3/ch16/02-fig-enformer-architecture.svg)
...
![Regulatory genomics assays and their signals](../figs/part_3/ch16/06-fig-regulatory-assays.svg)
...
![RNA-seq captures post-transcriptional processing](../figs/part_3/ch16/04-A-fig-borzoi-rnaseq.svg)

![Borzoi predicts coverage at nucleotide resolution](../figs/part_3/ch16/04-B-fig-borzoi-rnaseq.svg)

![Variant effects on RNA processing](../figs/part_3/ch16/04-C-fig-borzoi-rnaseq.svg)

![Integration with specialized splicing models](../figs/part_3/ch16/04-D-fig-borzoi-rnaseq.svg)
...
::: {#fig-sei-vocabulary}
![Sei regulatory vocabulary classes](../figs/part_3/ch16/07-fig-sei-vocabulary.svg)
...
These biases propagate to variant effect predictions. A variant in a regulatory element active primarily in pancreatic beta cells may receive poor predictions if beta cell data is sparse in training. A variant on a **haplotype** common in African populations but rare in Europeans may fall outside the model's effective training distribution. Users must recognize that prediction confidence varies with representation in training data, a consideration that current models do not explicitly communicate. @sec-ch12-confounding examines how such biases can compromise model validity.
...
- See @sec-ch17-vep-fm for detailed variant interpretation workflows

**Looking Forward:**

- @sec-ch17-vep-fm: How to combine regulatory model predictions with other evidence
- @sec-ch20-3d-genome: Models that explicitly address chromatin architecture
- @sec-ch24-interpretability: Methods for probing what these models learn
- @sec-ch28-rare-disease: Clinical application in diagnostic workflows
:::
