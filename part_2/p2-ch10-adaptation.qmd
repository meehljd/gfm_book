...
![Encoder model layer-wise performance](../figs/part_2/ch10/02-A-fig-layer-probing-decoder.svg)

![Decoder model layer-wise performance](../figs/part_2/ch10/02-B-fig-layer-probing-decoder.svg)
...
![Decision framework for adaptation strategy selection](../figs/part_2/ch10/03-fig-adaptation-decision-tree.svg)
...
![Embedding space visualization](../figs/part_2/ch10/04-A-fig-domain-shift-detection.svg)

![Calibration comparison](../figs/part_2/ch10/04-B-fig-domain-shift-detection.svg)

![Performance degradation curve](../figs/part_2/ch10/04-C-fig-domain-shift-detection.svg)
...
- Evaluation methodology separates real from spurious gains (@sec-ch11-eval)
- Confounding sources inflate benchmarks (@sec-ch12-confounding)
- Uncertainty quantification enables appropriate abstention (@sec-ch23-uncertainty)
- Clinical deployment requires calibration to deployment prevalence (@sec-ch27-clinical-risk)
:::
