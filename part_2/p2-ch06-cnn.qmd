...
## Convolutions as Sequence Pattern Detectors {#sec-ch06-convolutions-sequence-pattern-detectors}
...
## *DeepSEA*: Regulatory Prediction from Sequence {#sec-ch06-deepsea-regulatory-prediction-sequence}
...
### Architecture and Training {#sec-ch06-architecture-training}
...
### Learned Representations and Biological Validation {#sec-ch06-learned-representations-biological}
...
### Variant Effect Prediction {#sec-ch06-variant-effect-prediction}
...
Systematic characterization of regulatory elements requires more than single-variant scoring. **In silico saturation mutagenesis** predicts effects of all possible substitutions across a regulatory element, identifying positions where mutations most strongly perturb function. These critical positions typically correspond to transcription factor binding motifs, providing motif discovery that emerges from learned representations rather than explicit sequence alignment. The approach enables characterization of any regulatory element, including those in cell types or conditions never experimentally profiled. The broader context of variant effect prediction methods, including how foundation models have extended these approaches, is examined in @sec-vep-fm.


## Cell-Type Specificity and Regulatory Grammar {#sec-ch06-cell-type-specificity-regulatory-grammar}
...
## *ExPecto*: From Chromatin to Expression {#sec-ch06-expecto-chromatin-expression}
...
### Modular Architecture {#sec-ch06-modular-architecture}
...
### Expression Prediction and Variant Effects {#sec-ch06-expression-prediction-variant-effects}
...
### Architecture: Depth and Dilation {#sec-ch06-architecture-depth-dilation}
...
### Performance and Validation {#sec-ch06-performance-validation}
...
### Clinical Impact {#sec-ch06-clinical-impact}
...
This clinical utility explains *SpliceAI*'s rapid adoption. Illumina integrated *SpliceAI* into their annotation pipelines. Clinical genetics laboratories worldwide use delta scores to flag potential splice-affecting variants for RNA-seq follow-up. The model exemplifies how task-specific deep learning can achieve clinical-grade accuracy on well-defined problems. *SpliceAI*'s role in modern variant interpretation workflows, including integration with foundation model approaches, is examined in @sec-vep-fm.


## Receptive Field Ceiling {#sec-ch06-receptive-field-ceiling}
...
## Sequential Approaches and Their Costs {#sec-ch06-sequential-approaches-costs}
...
### Vanishing Gradient Problem {#sec-ch06-vanishing-gradient-problem}
...
### *DanQ*: Combining Convolutions and Recurrence {#sec-ch06-danq-integration-convolutions-recurrence}
