...
As genomic language models have matured (see @sec-dna and @sec-princ), dedicated benchmark suites have emerged to assess their representation quality and task performance in a more comprehensive and standardized manner.
