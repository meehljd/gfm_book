...
# Multi-Omics Integration & Systems Biology  {#sec-systems}
...
Single-cell and epigenomic foundation models from @sec-singlecell bring methylation, cellular identity, and 3D genome structure into the picture. CpGPT treats methylation as a foundation modeling problem. scGPT and Geneformer learn cellular representations from massive transcriptomic corpora. GLUE enables integration across modalities measured in different cells.
