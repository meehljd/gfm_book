...
As genomic language models have matured (see @sec-dna and @sec-foundation), dedicated benchmark suites have emerged to assess their representation quality and task performance in a more comprehensive and standardized manner.
...
Models that score variants (as discussed in @sec-vep) are commonly assessed on such benchmarks using metrics like AUROC, AUPRC, and calibration diagnostics.
