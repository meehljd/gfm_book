...
This document tracks papers that need to be added to Zotero and exported to the chapter `.bib` files.

## Instructions

1. Add each paper to your Zotero project
2. Verify the citation key matches the expected key (or update the chapter citation)
3. Export to the appropriate `bib/p{part}/p{part}-ch{chapter}.bib` file
4. Check off the paper below once added

---

## Chapter 01: From Reads to Variants

| Status | Expected Citation Key | Full Reference | Target Bib |
|--------|----------------------|----------------|------------|
| [ ] | `zanger_cytochrome_2013` | Zanger UM, Schwab M. **Cytochrome P450 enzymes in drug metabolism: regulation of gene expression, enzyme activities, and impact of genetic variation.** *Pharmacol Ther.* 2013;138(1):103-141. doi:10.1016/j.pharmthera.2013.01.001 | `bib/p1/p1-ch01.bib` |
| [ ] | `ingelman-sundberg_genetic_2005` | Ingelman-Sundberg M. **Genetic polymorphisms of cytochrome P450 2D6 (CYP2D6): clinical consequences, evolutionary aspects and functional diversity.** *Pharmacogenomics J.* 2005;5(1):6-13. doi:10.1038/sj.tpj.6500285 | `bib/p1/p1-ch01.bib` |

---

## Chapter 02: Data Landscape

### Protein Databases (new section)

| Status | Expected Citation Key | Full Reference | Target Bib |
|--------|----------------------|----------------|------------|
| [ ] | `@uniprot_2023` | UniProt Consortium. **UniProt: the Universal Protein Knowledgebase in 2023.** *Nucleic Acids Research.* 2023;51(D1):D523-D531. doi:10.1093/nar/gkac1052 | `bib/p1/p1-ch02.bib` |
| [ ] | `@suzek_uniref_2015` | Suzek BE, Wang Y, Huang H, McGarvey PB, Wu CH. **UniRef clusters: a comprehensive and scalable alternative for improving sequence similarity searches.** *Bioinformatics.* 2015;31(6):926-932. doi:10.1093/bioinformatics/btu739 | `bib/p1/p1-ch02.bib` |
| [ ] | `@steinegger_bfd_2019` | Steinegger M, Mirdita M, Söding J. **Protein-level assembly increases protein sequence recovery from metagenomic samples manyfold.** *Nature Methods.* 2019;16(7):603-606. doi:10.1038/s41592-019-0437-4 | `bib/p1/p1-ch02.bib` |
| [ ] | `@berman_pdb_2000` | Berman HM, Westbrook J, Feng Z, et al. **The Protein Data Bank.** *Nucleic Acids Research.* 2000;28(1):235-242. doi:10.1093/nar/28.1.235 | `bib/p1/p1-ch02.bib` |
| [ ] | `@varadi_alphafold_2022` | Varadi M, Anyango S, Deshpande M, et al. **AlphaFold Protein Structure Database: massively expanding the structural coverage of protein-sequence space with high-accuracy models.** *Nucleic Acids Research.* 2022;50(D1):D439-D444. doi:10.1093/nar/gkab1061 | `bib/p1/p1-ch02.bib` |
| [ ] | `@jumper_alphafold2_2021` | Jumper J, Evans R, Pritzel A, et al. **Highly accurate protein structure prediction with AlphaFold.** *Nature.* 2021;596(7873):583-589. doi:10.1038/s41586-021-03819-2 | `bib/p1/p1-ch02.bib` |

### Phenotype Quality (missing citations filled)

| Status | Expected Citation Key | Full Reference | Target Bib |
|--------|----------------------|----------------|------------|
| [ ] | `@birman-deych_icd_2005` | Birman-Deych E, Waterman AD, Yan Y, Nilasena DS, Radford MJ, Gage BF. **Accuracy of ICD-9-CM codes for identifying cardiovascular and stroke risk factors.** *Medical Care.* 2005;43(5):480-485. doi:10.1097/01.mlr.0000160417.39497.a9 | `bib/p1/p1-ch02.bib` |
| [ ] | `@quan_coding_2005` | Quan H, Sundararajan V, Halfon P, et al. **Coding algorithms for defining comorbidities in ICD-9-CM and ICD-10 administrative data.** *Medical Care.* 2005;43(11):1130-1139. doi:10.1097/01.mlr.0000182534.19832.83 | `bib/p1/p1-ch02.bib` |
| [ ] | `@ahlqvist_t2d-clusters_2018` | Ahlqvist E, Storm P, Käräjämäki A, et al. **Novel subgroups of adult-onset diabetes and their association with outcomes: a data-driven cluster analysis of six variables.** *Lancet Diabetes & Endocrinology.* 2018;6(5):361-369. doi:10.1016/S2213-8587(18)30051-2 | `bib/p1/p1-ch02.bib` |

---

## Chapter 03: GWAS and Polygenic Scores

| Status | Expected Citation Key | Full Reference | Target Bib |
|--------|----------------------|----------------|------------|
| [ ] | `chen_rates_2023` | Chen E, Facio FM, Aradhya KW, et al. **Rates and Classification of Variants of Uncertain Significance in Hereditary Disease Genetic Testing.** *JAMA Netw Open.* 2023;6(10):e2339571. doi:10.1001/jamanetworkopen.2023.39571 | `bib/p1/p1-ch03.bib` |
| [ ] | `mukherjee_embedgem_2024` | Mukherjee S, McCaw ZR, Pei J, et al. **EmbedGEM: a framework to evaluate the utility of embeddings for genetic discovery.** *Bioinformatics Advances.* 2024;4(1):vbae135. doi:10.1093/bioadv/vbae135 | `bib/p1/p1-ch03.bib` |

---

## Chapter 04: Classical Variant Prediction

### Missing Citations

| Status | Expected Citation Key | Full Reference | Target Bib |
|--------|----------------------|----------------|------------|
| [ ] | `hubisz_exploring_2014` | Hubisz MJ, Pollard KS. **Exploring the genesis and functions of Human Accelerated Regions sheds light on their role in human evolution.** *Curr Opin Genet Dev.* 2014;29:15-21. doi:10.1016/j.gde.2014.07.005 | `bib/p1/p1-ch04.bib` |
| [ ] | `rentzsch_cadd-splice_2021` | Rentzsch P, Schubach M, Shendure J, Kircher M. **CADD-Splice—improving genome-wide variant effect prediction using deep learning-derived splice scores.** *Genome Med.* 2021;13:31. doi:10.1186/s13073-021-00835-9 | `bib/p1/p1-ch04.bib` |
| [ ] | `schubach_cadd_2024` | Schubach M, Maass T, Nazaretyan L, Röner S, Kircher M. **CADD v1.7: using protein language models, regulatory CNNs and other nucleotide-level scores to improve genome-wide variant predictions.** *Nucleic Acids Res.* 2024;52(D1):D1143-D1154. doi:10.1093/nar/gkad989 | `bib/p1/p1-ch04.bib` |
| [ ] | `grantham_amino_1974` | Grantham R. **Amino acid difference formula to help explain protein evolution.** *Science.* 1974;185(4154):862-864. doi:10.1126/science.185.4154.862 | `bib/p1/p1-ch04.bib` |
| [ ] | `lek_analysis_2016` | Lek M, Karczewski KJ, Minikel EV, et al. **Analysis of protein-coding genetic variation in 60,706 humans.** *Nature.* 2016;536(7616):285-291. doi:10.1038/nature19057 | `bib/p1/p1-ch04.bib` |
| [ ] | `karczewski_mutational_2020` | Karczewski KJ, Francioli LC, Tiao G, et al. **The mutational constraint spectrum quantified from variation in 141,456 humans.** *Nature.* 2020;581(7809):434-443. doi:10.1038/s41586-020-2308-7 | `bib/p1/p1-ch04.bib` |
...
## Chapter 05: Tokens and Embeddings

### Circularity in Evaluation (foundational paper)

| Status | Expected Citation Key | Full Reference | Target Bib |
|--------|----------------------|----------------|------------|
| [ ] | `grimm_evaluation_2015` | Grimm DG, Azencott CA, Aber F, et al. **The Evaluation of Tools Used to Predict the Impact of Missense Variants Is Hindered by Two Types of Circularity.** *Human Mutation.* 2015;36(5):513-523. doi:10.1002/humu.22768 | `bib/p2/p2-ch05.bib` |

### BPE Algorithm (foundational method)

| Status | Expected Citation Key | Full Reference | Target Bib |
|--------|----------------------|----------------|------------|
| [ ] | `gage_bpe_1994` | Gage P. **A New Algorithm for Data Compression.** *C Users Journal.* 1994;12(2):23-38. | `bib/p2/p2-ch05.bib` |
| [ ] | `sennrich_bpe_2016` | Sennrich R, Haddow B, Birch A. **Neural Machine Translation of Rare Words with Subword Units.** *Proceedings of the 54th Annual Meeting of the Association for Computational Linguistics (ACL).* 2016:1715-1725. doi:10.18653/v1/P16-1162 | `bib/p2/p2-ch05.bib` |

### State Space Models (sub-quadratic architectures)

| Status | Expected Citation Key | Full Reference | Target Bib |
|--------|----------------------|----------------|------------|
| [ ] | `gu_mamba_2023` | Gu A, Dao T. **Mamba: Linear-Time Sequence Modeling with Selective State Spaces.** *arXiv preprint arXiv:2312.00752.* 2023. | `bib/p2/p2-ch05.bib` |
| [ ] | `gu_s4_2022` | Gu A, Goel K, Ré C. **Efficiently Modeling Long Sequences with Structured State Spaces.** *ICLR.* 2022. arXiv:2111.00396 | `bib/p2/p2-ch05.bib` |

### Other Missing Citations (need verification)

| Status | Expected Citation Key | Full Reference | Target Bib |
|--------|----------------------|----------------|------------|
| [ ] | `TBD` | **Circular genome position encodings** - Specific model implementing circular position encodings for bacterial/mitochondrial genomes. *Needs research to identify appropriate source or consider removing claim.* | `bib/p2/p2-ch05.bib` |

---

## Chapter 07: Transformers and Attention

### Citations used but missing from bib file

| Status | Expected Citation Key | Full Reference | Target Bib |
|--------|----------------------|----------------|------------|
| [ ] | `brixi_evo_2025` | Brixi G, Durairaj J, et al. **Genome modeling and design across all domains of life with Evo 2.** *bioRxiv.* 2025. doi:10.1101/2025.02.18.638918 | `bib/p2/p2-ch07.bib` |
| [ ] | `dallatorre_nucleotide_2024` | Dalla-Torre H, Gonzalez L, et al. **Nucleotide Transformer v2: Optimizing Nucleotide Transformers for Efficient Foundation Models.** *Nature Methods.* 2024 (part of main NT paper updates). | `bib/p2/p2-ch07.bib` |
| [ ] | `nguyen_sequence_2024` | Nguyen E, Poli M, Durrant MG, et al. **Sequence modeling and design from molecular to genome scale with Evo.** *Science.* 2024;386(6723):eado9336. doi:10.1126/science.ado9336 | `bib/p2/p2-ch07.bib` |
| [ ] | `schiff_caduceus_2024` | Schiff Y, Kao C-H, Gokaslan A, et al. **Caduceus: Bi-directional equivariant long-range DNA sequence modeling.** *ICML.* 2024. arXiv:2403.03234 | `bib/p2/p2-ch07.bib` |

### Models mentioned without citations (need to add citations to chapter)

| Status | Model | Suggested Citation Key | Full Reference | Target Bib |
|--------|-------|----------------------|----------------|------------|
| [ ] | ESM-2 | `lin_evolutionary_2023` | Lin Z, Akin H, Rao R, et al. **Evolutionary-scale prediction of atomic-level protein structure with a language model.** *Science.* 2023;379(6637):1123-1130. doi:10.1126/science.ade2574 | `bib/p2/p2-ch07.bib` |
| [ ] | Borzoi | `linder_borzoi_2023` | Linder J, Srivastava D, Yuan H, Aber V, Kelley DR. **Predicting RNA-seq coverage from DNA sequence as a unifying model of gene regulation.** *bioRxiv.* 2023. doi:10.1101/2023.08.30.555582 | `bib/p2/p2-ch07.bib` |
| [ ] | DNABERT-2 | `zhou_dnabert2_2024` | Zhou Z, Ji Y, Li W, Dutta P, Davuluri R, Liu H. **DNABERT-2: Efficient Foundation Model and Benchmark For Multi-Species Genome.** *ICLR.* 2024. arXiv:2306.15006 | `bib/p2/p2-ch07.bib` |
...
| Line | Chapter Uses | Bib File Has | Action |
|------|--------------|--------------|--------|
| 72 | `@hoffmann_training_2022` | `@hoffmann_chinchilla_2022` | Update chapter to use `@hoffmann_chinchilla_2022` |
| 26 | `@rives_esm_2021` | `@rives_biological_2021` | Update chapter to use `@rives_biological_2021` |
...
- If Zotero generates a different key, either:
  - Rename the key in the exported `.bib` file to match, or
  - Update the citation in the chapter `.qmd` file to use the actual key
- Papers already in the bib files don't need to be re-added
