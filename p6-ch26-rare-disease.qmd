# Rare Disease and Variant Interpretation {#sec-rare-disease}
...
The next chapter extends these interpretive principles to therapeutic discovery, examining how foundation models identify drug targets, predict biomarkers, and guide precision medicine approaches beyond diagnosis (@sec-drug-discovery).