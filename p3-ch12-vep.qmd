...
In Chapter 12 (@sec-vep), after discussing EVE and ESM-1v zero-shot approaches but before moving to AlphaMissense. It bridges the purely unsupervised PLM methods with structure-aware foundation models, showing how modest supervision from DMS data adds substantial value on top of pretrained representations.
