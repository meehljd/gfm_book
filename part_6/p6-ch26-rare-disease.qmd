...
![**FIGURE PLACEHOLDER**](../figs/part_6/ch26/01-fig-rare-disease-funnel.png)
...
::: {#fig-acmg-amp}
![**FIGURE PLACEHOLDER**](../figs/part_6/ch26/02-fig-acmg-amp.png)
...
![**FIGURE PLACEHOLDER A**](../figs/part_6/ch26/03-A-fig-family-analysis.png)

![**FIGURE PLACEHOLDER B**](../figs/part_6/ch26/03-B-fig-family-analysis.png)

![**FIGURE PLACEHOLDER C**](../figs/part_6/ch26/03-C-fig-family-analysis.png)

[High] Three-panel scenarios. Panel A (*de novo* Detection): Trio pedigree; variant present in proband, absent in parents; strong evidence (PS2); FM prioritizes among multiple de novos. Panel B (Compound Het Trans): Two variants in same gene from different parents; biallelic disruption; FM assesses severity of each. Panel C (Compound Het Cis): Both from same parent; one functional copy remains; recessive does not fit; FM identifies if either alone sufficient. Phasing methods sidebar: Long-read, trio, statistical.
:::
...
![**FIGURE PLACEHOLDER A**](../figs/part_6/ch26/04-A-fig-somatic-germline.png)

![**FIGURE PLACEHOLDER B**](../figs/part_6/ch26/04-B-fig-somatic-germline.png)
...
![**FIGURE PLACEHOLDER**](../figs/part_6/ch26/05-fig-functional-validation.png)
...
![**FIGURE PLACEHOLDER**](../figs/part_6/ch26/06-fig-interpretive-partnership.png)
