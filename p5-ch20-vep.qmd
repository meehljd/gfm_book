...
Variant effect prediction (VEP) sits at the intersection of sequence analysis, machine learning, and clinical genetics. This chapter provides comprehensive treatment of VEP methods, from early conservation-based scores through modern foundation models. Earlier chapters introduced specific aspects of this landscape: @sec-cadd covered annotation-based methods like CADD and established key concepts including circularity and benchmark design; @sec-cnn examined CNN-based approaches including SpliceAI for splice variants; @sec-prot described protein language models and their application to missense variant scoring. Here we synthesize these threads, examine the full spectrum of VEP approaches, and address cross-cutting challenges in evaluation, calibration, and clinical deployment.

For readers primarily interested in clinical workflows and how VEP tools fit into diagnostic pipelines, @sec-variants provides application-focused perspective. This chapter focuses on the models themselves: what they learn, how they are trained and evaluated, and what their predictions mean.
