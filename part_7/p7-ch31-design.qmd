...
4. mRNA must be manufactured and delivered, adding constraints proteins do not face
...
::: {.callout-note title="Stop and Think"}
Recall multi-objective optimization from protein design (@sec-ch31-multi-objective). For an mRNA therapeutic, you need to balance: (1) high translation efficiency, (2) long mRNA half-life, (3) low immunogenicity, and (4) manufacturability. Why cannot you simply maximize each property independently? What is the likely tradeoff between translation efficiency and immunogenicity?
