...
Protein language models add coding variant interpretation. *AlphaMissense* and related systems predict pathogenicity for missense mutations based on evolutionary conservation patterns learned from millions of protein sequences, as discussed in @sec-ch16-protein-lm. For conditions with strong coding variant contributions (Mendelian cardiomyopathies, cancer predisposition syndromes), these predictions provide important signal beyond what noncoding regulatory models capture.
