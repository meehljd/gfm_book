...
![**FIGURE PLACEHOLDER**](../figs/part_5/ch24/01-fig-attribution-comparison.png)
...
![**FIGURE PLACEHOLDER A**](../figs/part_5/ch24/02-A-fig-in-silico-mutagenesis.png)

![**FIGURE PLACEHOLDER B**](../figs/part_5/ch24/02-B-fig-in-silico-mutagenesis.png)

![**FIGURE PLACEHOLDER C**](../figs/part_5/ch24/02-C-fig-in-silico-mutagenesis.png)

![**FIGURE PLACEHOLDER D**](../figs/part_5/ch24/02-D-fig-in-silico-mutagenesis.png)
...
::: {#fig-tfmodisco}
![**FIGURE PLACEHOLDER**](../figs/part_5/ch24/03-fig-tfmodisco.png)
...
![**FIGURE PLACEHOLDER A**](../figs/part_5/ch24/04-A-fig-attention-visualization.png)

![**FIGURE PLACEHOLDER B**](../figs/part_5/ch24/04-B-fig-attention-visualization.png)

![**FIGURE PLACEHOLDER C**](../figs/part_5/ch24/04-C-fig-attention-visualization.png)
...
![**FIGURE PLACEHOLDER**](../figs/part_5/ch24/05-fig-plausible-vs-faithful.png)

[Essential] Two-path diagram. Scenario: Model predicts high enhancer activity. Path A (Plausible but unfaithful): Attribution highlights GATA motif (biologically reasonable); but model learned GC content correlate; validation fails (mutating GATA does not change prediction; inserting GATA does not increase); explanation matches intuition not computation. Path B (Faithful): Attribution highlights GATA; validation succeeds (mutating reduces prediction; inserting increases). Validation tests: Necessity (removing reduces?), Sufficiency (adding increases?), Sanity checks (random weights different?). Key distinction: Plausible matches intuition; faithful reflects computation; unfaithful provides false comfort.
:::
...
![**FIGURE PLACEHOLDER**](../figs/part_5/ch24/06-fig-validation-pipeline.png)
...
![**FIGURE PLACEHOLDER**](../figs/part_5/ch24/07-fig-clinical-interpretability.png)
