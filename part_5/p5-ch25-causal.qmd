...
**From @sec-ch12-confounding**: We learned that population structure creates spurious associations in GWAS. Before reading about Mendelian randomization, consider: How might the random assignment of alleles at conception help overcome confounding? What makes genetic variants different from environmental exposures?
:::
...
### Model-X Knockoffs for Controlled Variable Selection {#sec-ch25-knockoffs}
...
::: {.callout-tip title="Recall and Connect"}
**From @sec-ch24-interpretability**: We learned that attention weights in transformers show which inputs the model considers important. Now think critically: If attention from gene A to gene B is high, does this prove A regulates B? What's the difference between computational attention and biological causation?
:::
