...
The foundation models examined in preceding chapters address each layer individually: sequence models predict regulatory effects from DNA (@sec-regulatory-models), expression models capture transcriptional programs (@sec-transcriptomics), and protein language models predict structure and function from amino acid sequence (@sec-protein-lm). Multi-omics integration asks how these modality-specific representations can be combined into unified patient or cell representations.
