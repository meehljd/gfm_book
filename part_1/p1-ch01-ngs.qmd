...
::: {.callout-note collapse="true" title="Check Your Answer"}
1. **Three signal sources:** (1) sequencing errors from instrument noise and library preparation, (2) alignment artifacts when reads map to incorrect genomic locations, and (3) genuine biological variation including germline variants, somatic mutations, and mosaicism. All three produce identical-looking mismatches in the data.
