...
::: {.callout-note title="Predict Before You Look"}
Think back to *Enformer* from @sec-ch16-regulatory, which uses dilated convolutions to expand its receptive field. How might *Orca's* multiscale approach differ from simply using more extreme dilation rates? What architectural advantage does explicit multi-resolution prediction provide?
:::
